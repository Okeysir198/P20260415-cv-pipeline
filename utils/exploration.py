...
Usage (exploration)::
    ...
    uv run utils/exploration.py explore --config features/safety-fire_detection/configs/05_data.yaml

Usage (normalization)::

    uv run utils/exploration.py normalize --config features/safety-fire_detection/configs/05_data.yaml
    uv run utils/exploration.py normalize --config features/safety-fire_detection/configs/05_data.yaml --sample-size 2000
"""
