"""Combine fire_detection + fall_detection training_ready/ into fire_smoke_fall/.
...
Filenames are prefixed with `fire__` / `fall__` to avoid collisions.
...
def main() -> None:
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=DATASET_ROOT / "fire_smoke_fall",
