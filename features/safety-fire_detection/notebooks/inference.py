#!/usr/bin/env python3
"""Run inference with Fire Detection model.

Usage:
    python features/safety-fire_detection/experiments/inference.py --image path/to/image.jpg
    python features/safety-fire_detection/experiments/inference.py --video path/to/video.mp4
"""
