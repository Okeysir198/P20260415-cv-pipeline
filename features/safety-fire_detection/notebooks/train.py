...
Usage:
    python features/safety-fire_detection/experiments/train.py
    python features/safety-fire_detection/experiments/train.py --resume runs/fire_detection/last.pth
    python features/safety-fire_detection/experiments/train.py --override training.lr=0.005
"""
...
DEFAULT_CONFIG = "features/safety-fire_detection/configs/06_training.yaml"
