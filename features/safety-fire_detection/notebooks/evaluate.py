...
Usage:
    python features/safety-fire_detection/experiments/evaluate.py
    python features/safety-fire_detection/experiments/evaluate.py --model runs/fire_detection/best.pt --split test
"""
...
DEFAULT_DATA_CONFIG = "features/safety-fire_detection/configs/05_data.yaml"
