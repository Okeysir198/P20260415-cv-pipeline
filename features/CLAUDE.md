...
| `safety-poketenashi_point_and_call` | Pose orchestrator | 🔧 Pretrained only | dwpose_384_pose | — | 🔴 v1.2-A' F1=0.138 (Δ +0.035 vs locked baseline 0.103, 2026-04-29) — rest-between-directions added; 32 lecture FPs remain |
