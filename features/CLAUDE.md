...
| `safety-poketenashi_point_and_call` | Pose orchestrator | 🔧 Pretrained only | dwpose_384_pose | — | 🟢 v1.6 F1=0.737 (P=0.636, R=0.875), Δ +0.634 vs baseline 0.103, 2026-04-29 — 7.2× baseline, per-section polygons landed |
