...
Usage:
    python features/safety-fall_classification/experiments/evaluate.py
    python features/safety-fall_classification/experiments/evaluate.py --model runs/fall_classification/best.pt --split test
"""
