#!/usr/bin/env python3
"""Run inference with Fall Classification model.

Usage:
    python features/safety-fall_classification/experiments/inference.py --image path/to/image.jpg
    python features/safety-fall_classification/experiments/inference.py --video path/to/video.mp4
"""
...
DEFAULT_DATA_CONFIG = "features/safety-fall_classification/configs/05_data.yaml"


def main():
    import argparse

    parser = argparse.ArgumentParser(description="Run Fall Classification inference")
