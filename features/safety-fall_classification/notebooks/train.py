...
Usage:
    python features/safety-fall_classification/experiments/train.py
    python features/safety-fall_classification/experiments/train.py --resume runs/fall_classification/last.pth
    python features/safety-fall_classification/experiments/train.py --override training.lr=0.005
"""
...
DEFAULT_CONFIG = "features/safety-fall_classification/configs/06_training.yaml"
