#!/usr/bin/env python3
"""Export Fall Classification model to ONNX.

Usage:
    python features/safety-fall_classification/experiments/export.py
    python features/safety-fall_classification/experiments/export.py --model runs/fall_classification/best.pt
"""
...
DEFAULT_MODEL = "runs/fall_classification/best.pt"
DEFAULT_TRAINING_CONFIG = "features/safety-fall_classification/configs/06_training.yaml"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Export Fall Classification model to ONNX")
    ...
    exporter = ModelExporter(model, export_config, model_name="fall_classify")
