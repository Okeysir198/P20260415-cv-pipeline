...
| Dataset | `dataset_store/training_ready/fall_classification/` |
| Dataset report | `../../dataset_store/training_ready/fall_classification/DATASET_REPORT.md` |

## Layout

```
features/safety-fall_classification/
...
uv run python core/p06_training/train.py \
  --config features/safety-fall_classification/configs/06_training.yaml

# Evaluate
uv run python core/p08_evaluation/evaluate.py \
  --model features/safety-fall_classification/runs/best.pt \
...
uv run python core/p10_inference/video.py \
  --config features/safety-fall_classification/configs/10_inference.yaml \
  --video features/safety-fall_classification/samples/demo.mp4
```
...
```yaml
# features/safety-fall_classification/configs/06_training.yaml
training:
  backend: custom
  custom_trainer_class: features.safety-fall_classification.code.custom_trainer.MyTrainer
```
