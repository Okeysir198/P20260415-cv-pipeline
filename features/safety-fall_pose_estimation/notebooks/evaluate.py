#!/usr/bin/env python3
"""Evaluate Fall Pose Estimation model.

Usage:
    python features/safety-fall_pose_estimation/experiments/evaluate.py
    python features/safety-fall_pose_estimation/experiments/evaluate.py --model runs/fall_pose_estimation/best.pt --split test
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate Fall Pose Estimation model")
