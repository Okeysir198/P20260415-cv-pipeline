#!/usr/bin/env python3
"""Export Fall Pose Estimation model to ONNX.

Usage:
    python features/safety-fall_pose_estimation/experiments/export.py
    python features/safety-fall_pose_estimation/experiments/export.py --model runs/fall_pose_estimation/best.pt
"""
...
DEFAULT_TRAINING_CONFIG = "features/safety-fall_pose_estimation/configs/06_training.yaml"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Export Fall Pose Estimation model to ONNX")
    ...
    exporter = ModelExporter(model, export_config, model_name="fall_pose")
