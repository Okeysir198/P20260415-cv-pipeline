...
**Robustness status (2026-04-30 expanded baseline):** 🔴 **F1 = 0.042** (P=0.022, R=1.000) on the 6-video set. The earlier 0.800 was measured on 2 cherry-picked positive clips and was unrepresentative. Adding 4 true-negative videos (lecturer, railway pointing, continuous shisa-kanko, group calisthenics) exposes 91 FPs — the rule's `wrist_score < 0.3 → return True` shortcut fires on every gesturing/pointing actor where DWPose returns low-confidence wrists. Recall stays perfect at 1.000.
...
<!-- last auto-run: 2026-04-30 02:35 UTC -->

Aggregate: **2 TP, 91 FP, 0 FN**. Precision **0.022**, Recall **1.000**, F1 **0.042**.
...
| `POKETENASHI_anzen_daiichi_lecture.mp4` | 379 s | (none) | 32 (first @ 20.4 s) | ❌ FP × 32 |
| `POKETENASHI_autotech_indonesia_senam.mp4` | 200 s | (none) | 16 (first @ 17.3 s) | ❌ FP × 16 |
| `PO_hands_in_pockets_spkepcmwi.mp4` | 24 s | 2–22 s | 1 (first @ 6.3 s) | ✅ TP × 1 |
| `shisa_kanko_promotion_method.mp4` | 180 s | (none) | 19 (first @ 0.7 s) | ❌ FP × 19 |
| `shisa_kanko_railway_toyota.mp4` | 236 s | (none) | 23 (first @ 18.0 s) | ❌ FP × 23 |
<!-- AUTO:section_a:end -->
