#!/usr/bin/env python3
"""Export Zone Intrusion Detection model to ONNX.

Usage:
    python features/access-zone_intrusion/experiments/export.py
    python features/access-zone_intrusion/experiments/export.py --model runs/zone_intrusion/best.pt
"""
...
DEFAULT_TRAINING_CONFIG = "features/access-zone_intrusion/configs/06_training.yaml"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Export Zone Intrusion Detection model to ONNX")
    ...
    exporter = ModelExporter(model, export_config, model_name="zone")
