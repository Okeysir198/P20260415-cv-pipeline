#!/usr/bin/env python3
"""Evaluate Zone Intrusion Detection model.

Usage:
    python features/access-zone_intrusion/experiments/evaluate.py
    python features/access-zone_intrusion/experiments/evaluate.py --model runs/zone_intrusion/best.pt --split test
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate Zone Intrusion Detection model")
    ...
    # Load model from checkpoint — reuse evaluate.py logic
