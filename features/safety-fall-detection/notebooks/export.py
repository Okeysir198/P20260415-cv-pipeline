...
Usage:
    python features/safety-fall-detection/experiments/export.py
    python features/safety-fall-detection/experiments/export.py --model runs/fall_detection/best.pt
"""
...
DEFAULT_TRAINING_CONFIG = "features/safety-fall-detection/configs/06_training.yaml"
