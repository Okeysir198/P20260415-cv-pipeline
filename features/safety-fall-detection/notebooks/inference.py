...
Usage:
    python features/safety-fall-detection/experiments/inference.py --image path/to/image.jpg
    python features/safety-fall-detection/experiments/inference.py --video path/to/video.mp4
"""
