#!/usr/bin/env python3
"""Run inference with Safety Shoes Detection model.

Usage:
    python features/ppe-shoes_detection/experiments/inference.py --image path/to/image.jpg
    python features/ppe-shoes_detection/experiments/inference.py --video path/to/video.mp4
"""
...
DEFAULT_DATA_CONFIG = "features/ppe-shoes_detection/configs/05_data.yaml"


def main():
    import argparse

    parser = argparse.ArgumentParser(description="Run Safety Shoes Detection inference")
