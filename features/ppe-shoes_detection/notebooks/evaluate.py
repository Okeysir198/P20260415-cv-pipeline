#!/usr/bin/env python3
"""Evaluate Safety Shoes Detection model.

Usage:
    python features/ppe-shoes_detection/experiments/evaluate.py
    python features/ppe-shoes_detection/experiments/evaluate.py --model runs/shoes_detection/best.pt --split test
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate Safety Shoes Detection model")
