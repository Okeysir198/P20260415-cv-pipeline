#!/usr/bin/env python3
"""Export Safety Shoes Detection model to ONNX.

Usage:
    python features/ppe-shoes_detection/experiments/export.py
    python features/ppe-shoes_detection/experiments/export.py --model runs/shoes_detection/best.pt
"""
...
DEFAULT_MODEL = "runs/shoes_detection/best.pt"
DEFAULT_TRAINING_CONFIG = "features/ppe-shoes_detection/configs/06_training.yaml"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Export Safety Shoes Detection model to ONNX")
    ...
    exporter = ModelExporter(model, export_config, model_name="shoes")
