#!/usr/bin/env python3
"""Run inference with Vehicle Detection model.

Usage:
    python features/detect_vehicle/experiments/inference.py --image path/to/image.jpg
    python features/detect_vehicle/experiments/inference.py --video path/to/video.mp4
"""
...
DEFAULT_DATA_CONFIG = "features/detect_vehicle/configs/05_data.yaml"


def main():
    import argparse

    parser = argparse.ArgumentParser(description="Run Vehicle Detection inference")
