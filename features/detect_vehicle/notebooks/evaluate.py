...
Usage:
    python features/detect_vehicle/experiments/evaluate.py
    python features/detect_vehicle/experiments/evaluate.py --model runs/vehicle_detection/best.pt --split test
"""
