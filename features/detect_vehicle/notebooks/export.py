#!/usr/bin/env python3
"""Export Vehicle Detection model to ONNX.

Usage:
    python features/detect_vehicle/experiments/export.py
    python features/detect_vehicle/experiments/export.py --model runs/vehicle_detection/best.pt
"""
...
DEFAULT_MODEL = "runs/vehicle_detection/best.pt"
DEFAULT_TRAINING_CONFIG = "features/detect_vehicle/configs/06_training.yaml"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Export Vehicle Detection model to ONNX")
    ...
    exporter = ModelExporter(model, export_config, model_name="vehicle")
