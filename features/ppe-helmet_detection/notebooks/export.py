#!/usr/bin/env python3
"""Export Helmet Detection model to ONNX.

Usage:
    python features/ppe-helmet_detection/experiments/export.py
    python features/ppe-helmet_detection/experiments/export.py --model runs/helmet_detection/best.pt
"""
...
DEFAULT_MODEL = "runs/helmet_detection/best.pt"
DEFAULT_TRAINING_CONFIG = "features/ppe-helmet_detection/configs/06_training.yaml"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Export Helmet Detection model to ONNX")
    ...
    exporter = ModelExporter(model, export_config, model_name="helmet")
