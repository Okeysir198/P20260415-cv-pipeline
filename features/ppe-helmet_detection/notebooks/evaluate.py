...
Usage:
    python features/ppe-helmet_detection/experiments/evaluate.py
    python features/ppe-helmet_detection/experiments/evaluate.py --model runs/helmet_detection/best.pt --split test
"""
