...
Usage:
    python features/ppe-helmet_detection/experiments/train.py
    python features/ppe-helmet_detection/experiments/train.py --resume runs/helmet_detection/last.pth
    python features/ppe-helmet_detection/experiments/train.py --override training.lr=0.005
"""
...
DEFAULT_CONFIG = "features/ppe-helmet_detection/configs/06_training.yaml"
