#!/usr/bin/env python3
"""Run inference with Helmet Detection model.

Usage:
    python features/ppe-helmet_detection/experiments/inference.py --image path/to/image.jpg
    python features/ppe-helmet_detection/experiments/inference.py --video path/to/video.mp4
"""
...
DEFAULT_DATA_CONFIG = "features/ppe-helmet_detection/configs/05_data.yaml"
