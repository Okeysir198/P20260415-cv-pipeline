"""Shared fixtures and helpers for SAM3 service tests.

All tests require the SAM3 service running at localhost:18100.
"""
...
def _service_available() -> bool:
    """Check if the SAM3 service is reachable."""
    try:
...
skip_no_service = pytest.mark.skipif(
    ...
    reason="SAM3 service not running at localhost:18100",
)
...
def detections_from_masks(
    ...
    """Convert SAM3 API detections (with base64 masks + bbox) to sv.Detections."""
