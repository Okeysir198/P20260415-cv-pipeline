...
Source: notebooks/detr_finetune_reference/reference_dfine/DFine_finetune_on_a_custom_dataset.ipynb
Upstream: https://github.com/qubvel/transformers-notebooks

Run in the isolated notebook env:
    .venv-notebook/bin/python notebooks/detr_finetune_reference/reference_dfine/finetune.py
...
written under
`notebooks/detr_finetune_reference/reference_dfine/runs/dfine_large_cppe5_seed{SEED}{_TAG}/`
...
_HERE = Path(__file__).resolve().parent  # notebooks/detr_finetune_reference/reference_dfine/
